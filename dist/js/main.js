...
const im = new inputmask_es6('+375 (99) 999-99-99');
im.mask(inputsTel);
;// CONCATENATED MODULE: ./src/js/scripts/tabs-services.js
// (function () {
...
(function () {
  ...
  function hangeHeight() {
    contentItem.forEach(item => {
      const currInfo = item.querySelector('.tabs-services__content-info.active');
  ...
  buttons.forEach((btn, i) => {
    btn.addEventListener('click', () => {
      ...
      btn.classList.add('active');
      contentItem.forEach(item => {
        const currInfo = item.querySelectorAll('.tabs-services__content-info')[i];
      ...
      i === 4 ? imgMoon.classList.add('active') : imgMoon.classList.remove('active');
...
;// CONCATENATED MODULE: ./src/js/scripts/tabs-price.js
(function () {
